...
{
	return ModelInfo()->FindModel(cache);
}
...
public:
	inline int boneFlags(int iBone) { return m_boneFlags[iBone]; }
	inline int boneParent(int iBone) { return m_boneParent[iBone]; }
...
public:
	...
	public:
		...
		CActivityToSequenceMapping(void)
			: m_pSequenceTuples(NULL), m_iSequenceTuplesCount(0), m_ActToSeqHash(8), m_expectedPStudioHdr(NULL), m_expectedVModel(NULL)
